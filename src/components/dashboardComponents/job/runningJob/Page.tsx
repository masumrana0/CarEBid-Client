...
import JobCardRun from "./JobCardRun";

const RunningJobComponentPage = () => {
  ...
  const { data, isLoading } = useGetAllRunningJobQuery(query);
...
export default RunningJobComponentPage;
