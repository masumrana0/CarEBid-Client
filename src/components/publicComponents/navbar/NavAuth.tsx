...
const NavAuth: React.FC = () => {
    ...
    return (
        <>
            <button onClick={showModal} className='px-6 py-3 rounded bg-green-400 hover:bg-green-500 font-[500] text-lg'>Sign In</button>
            <Modal
                title={<div className='flex items-center justify-center'><Image src={logo} className='w-16 h-16' width={500} height={500} alt="Car" /></div>}
                open={isModalVisible}
                footer={null}
